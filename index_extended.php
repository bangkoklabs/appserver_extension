...
Flight::route('GET /documents/@docId:[0-9]+/fields/', array($documentRequestHandler_extension, 'handleGetDocumentWithAllFields'), true);
Flight::route('GET /documents/@docId:[0-9]+/fields/@fields/', array($documentRequestHandler_extension, 'handleGetDocumentWithFields'), true); // $fields pipe (|) separated.
